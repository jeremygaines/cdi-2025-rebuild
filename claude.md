...
Right now this project is built as a Vue app that is hosted on the larger Drupal server for our site, and which uses the Drupal site's database for data and the site's stylesheet for certain styles. This makes it quite fragile and difficult to work with. I'd like to rebuild it as a standalone static react app that can be hosted somewhere like Vercel or Cloudflare Pages.

## reference materials
cdi_main_page.html and the associated files are a local copy of the web page for the main page of the CDI, creating by right clicking and hitting "save as" on that page. Certain icons and fonts are missing from the saved version, so it's not a perfect copy.

screencapture-dev-cgdev-pantheonsite-io-cdi-2026-01-12-01_03_35.png is a screenshot of the main page of the app.
